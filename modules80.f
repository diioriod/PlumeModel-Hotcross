...
!             end subroutine initialize_dummy_variables
        ...
        real, public:: sponge_factor, tau, c_d
        integer, public, save:: cdf_ids(100)
        integer, public:: bit1,bit2,bit3,bit4,bit5,bit6,bit7,bit8,bit9, bit10, bit11,bit12,bit13,bit14,bit15
        integer, public:: bit5k, bit2k
        integer, public:: delta, ismol, bcondx, bcondy, bottom_slip, side_slip, slipon, back, open_box 
        integer, public:: ismol_hx,ismol_hy,ismol_v
        integer, public:: toggle(13)
        integer, public:: number_of_output_blocks
        integer, public:: ismag_vertical, ismag_v, ismag_h
        integer, public:: spongex,spongey,spongee
        integer, public:: bdbit(1:4)
        integer,public, save:: nzls,nzle,nxls,nxle,nyls,nyle, ncapture1, ncapture2,ncapstart, 
     &                     ncapture3, ncapture4, ncapture5, ncapture6
        character * 90, public:: output_file_1, output_file_2, output_file_3,output_file_4
...
!       real, public:: spongex ( 0:nx+1, 0:ny+1, 0:nz+1 ), spongey ( 0:nx+1, 0:ny+1, 0:nz+1 ), spongez ( 0:nx+1, 0:ny+1, 0:nz+1 )
        real, public:: rhop(0:nx+1,0:ny+1,0:nz+1), rho_bkg(0:nz+1), ref_pressure
